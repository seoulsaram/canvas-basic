...
BarChart.prototype.drawVerticalLabels = function () {
  ...
  // Text Specifications
  var labelFont = ''
    .concat(chart.fontStyle, ' ')
    .concat(chart.fontWeight, ' ')
    .concat(chart.verticalFontSize, ' ')
    .concat(chart.fontFamily);
  chart.context.font = labelFont;
  chart.context.textAlign = 'right';
  chart.context.fillStyle = chart.fontColor;
  // Scale Values
  var scaledVerticalLabelFreq =
...
BarChart.prototype.drawBars = function () {
  var chart = this;
  for (var i = 0; i < chart.itemsNum; i++) {
    var _a = chart.createRandomRGBColor(),
      r = _a.r,
      g = _a.g,
      b = _a.b;
    var fillOpacity = 0.3;
